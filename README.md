...
For the remote repository, make a github repository named hw1-sklearn, then do;

```bash
git remote add origin git@github.com:nicky-html96/hw1-sklearn.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── hw1-sklearn	<- Your notebooks and scripts will live in the main project folder
